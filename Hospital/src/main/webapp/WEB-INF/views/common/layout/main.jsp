      ...
      <div class="container">
        ...
        <div class="row">
        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				<div class="img mb-4" style="background-image: url(${contextPath }/resources/dentacare-gh-pages/images/person_5.jpg);"></div>
        	...
        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				<div class="img mb-4" style="background-image: url(${contextPath }/resources/dentacare-gh-pages/images/person_6.jpg);"></div>
      				<div class="info text-center">
        	...
        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				<div class="img mb-4" style="background-image: url(${contextPath }/resources/dentacare-gh-pages/images/person_7.jpg);"></div>
      				<div class="info text-center">
        	...
        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				<div class="img mb-4" style="background-image: url(${contextPath }/resources/dentacare-gh-pages/images/person_8.jpg);"></div>
      				<div class="info text-center">
    ...
    <section class="ftco-section-parallax">
      ...
      <div class="container">
    	...
    	<div class="container-wrap">
    		<div class="row no-gutters">
					<div class="col-md-3 ftco-animate">
						<a href="#" class="gallery img d-flex align-items-center" style="background-image: url(${contextPath }/resources/dentacare-gh-pages/images/gallery-1.jpg);">
					...
					<div class="col-md-3 ftco-animate">
						<a href="#" class="gallery img d-flex align-items-center" style="background-image: url(${contextPath }/resources/dentacare-gh-pages/images/gallery-2.jpg);">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-search"></span>
    					</div>
						</a>
					...
					<div class="col-md-3 ftco-animate">
						<a href="#" class="gallery img d-flex align-items-center" style="background-image: url(${contextPath }/resources/dentacare-gh-pages/images/gallery-3.jpg);">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-search"></span>
    					</div>
						</a>
					...
					<div class="col-md-3 ftco-animate">
						<a href="#" class="gallery img d-flex align-items-center" style="background-image: url(${contextPath }/resources/dentacare-gh-pages/images/gallery-4.jpg);">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-search"></span>
    					</div>
						</a>
        ...
        <div class="row">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry" data-aos-delay="100">
              <a href="blog-single.html" class="block-20" style="background-image: url('${contextPath }/resources/dentacare-gh-pages/images/image_2.jpg');">
              </a>
              <div class="text d-flex py-4">
                <div class="meta mb-3">
                  <div><a href="#">Sep. 20, 2018</a></div>
